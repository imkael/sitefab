#version 3.6; 
#include "/var/www/html/custom3d/files/breast_2018_08_03_02-50-29.pov-inc"
...
camera {
	//orthographic
	sky <0,0,1>
	location <(430.286*-2),(338.946*-2),(171.6018*2.55)>
	look_at <0,0,(171.6018*0.45)>
	angle 35
	right -1.33*x
}
...
Axes_Macro
(
	500,	// Axes_axesSize,	The distance from the origin to one of the grid's edges.	(float)
