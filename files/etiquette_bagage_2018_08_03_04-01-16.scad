use<write/Write.scad>//Changetodirectorywherewrite.scadresides;
 = ; 
// Enter Text here
...
// You can use (up to) 10 lines for text
 ...
 = ; 
line_1 = ROCTON MIKAEL; 
line_2 = 2 Bis Rue des rameries; 
line_3 = 02850 Jaulgonne; 
line_4 = ; 
line_5 = "blop"; 
line_6 = ; 
line_7 = ; 
...
text_style=-80; // [-80:Deep engraving (80 %),-50:Half way through engraving (50 %),-10:Shallow engraving (10 %),0: Hide text inside (takes 66 %),10:Little embossing (10 %),25:Heavy embossing (25 %) ] 
 ...
 = ; 
font = writeLetters.dxf; //[write/orbitron.dxf:Futuristic,write/Letters.dxf:Basic,write/knewave.dxf:Round,write/BlackRose.dxf:Classic,write/braille.dxf:Braille]
...
/* [Plate options] */
 ...
 = ; 
// [mm]
plate_thickness = 4; //[1:5]

 = ; 
//Radius of plate corners [mm]
corner_radius = 4; //[1:10]
