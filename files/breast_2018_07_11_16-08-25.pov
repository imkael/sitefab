#version 3.6; 
#include "/var/www/html/custom3d/files/breast_2018_07_11_16-08-25.pov-inc"
...
camera {
	//orthographic
	sky <0,0,1>
	location <(322.714*-2),(254.209*-2),(128.7009*2.55)>
	look_at <0,0,(128.7009*0.45)>
	angle 35
	right -1.33*x
}
...
Axes_Macro
(
	400,	// Axes_axesSize,	The distance from the origin to one of the grid's edges.	(float)
