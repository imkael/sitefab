#version 3.6; 
#include "/var/www/html/custom3d/files/breast_2018_08_03_02-50-29_2018_08_03_02-51-28.pov-inc"
#include "/home/emilien/most-3-d-customizer/src/Scenes/Pov/axes_macro.inc"
#include "math.inc"
#include "finish.inc"
...
camera {
	//orthographic
	sky <0,0,1>
	location <(215.144*-2),(169.4731*-2),(85.80082*2.55)>
	look_at <0,0,(85.80082*0.45)>
	angle 35
	right -1.33*x
}
...
Axes_Macro
(
	300,	// Axes_axesSize,	The distance from the origin to one of the grid's edges.	(float)
