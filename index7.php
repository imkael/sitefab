...
?>
<!DOCTYPE html>
<!-- http://localhost/custom3d/index.php?scadfile=example.scad -->
...
require $_SERVER['DOCUMENT_ROOT'].'/custom3d/vendor/autoload.php';
...
if ($_SERVER["REQUEST_METHOD"] !== "POST") {
	...
	$scadfile = $_SERVER['DOCUMENT_ROOT'].'/custom3d/start/'.$_GET['scadfile'];
	...
	//@ workingDir need to have 777 permission.
	 $render3d->workingDir($_SERVER['DOCUMENT_ROOT'].'/custom3d/files/');
